...
describe('styled.withConfig', () => {
  test('Basic css calls without a config', () => {
    ...
    expect(cssString).toBe(
      '--sxs{--sxs:2 c-dataoT}@layer styled{.c-dataoT{color:DodgerBlue}}',
    );
  });
  ...
  test('Creates the correct className with a componentId', () => {
    ...
    expect(cssString).toBe(
      '--sxs{--sxs:2 c-cool-id}@layer styled{.c-cool-id{color:red}}',
    );
  });
  ...
  test('Creates the correct className with a displayName', () => {
    ...
    expect(cssString).toBe(
      '--sxs{--sxs:2 c-my-cool-display-name-gmqXFB}@layer styled{.c-my-cool-display-name-gmqXFB{color:red}}',
    );
  });
  ...
  test('Creates the correct className with a displayName and componentId', () => {
    ...
    expect(cssString).toBe(
      '--sxs{--sxs:2 c-my-cool-display-name-cool-id}@layer styled{.c-my-cool-display-name-cool-id{color:red}}',
    );
  });
  ...
  test('Creates the correct className with a componentConfig while extending components', () => {
    ...
    expect(cssString).toBe(
      '--sxs{--sxs:2 c-component-to-extend-id c-cool-component-id}@layer styled{.c-component-to-extend-id{color:red}.c-cool-component-id{color:blue}}',
    );
  });
});
