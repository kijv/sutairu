...
describe('Variants', () => {
  ...
  test('Renders a component with 1 matching variant', () => {
    ...
    expect(toString()).toBe(
      `--sxs{--sxs:3 c-PJLV-Gaggi-size-small}@layer onevar{${expression1CssText}}`,
    );
    ...
    expect(toString()).toBe(
      `--sxs{--sxs:3 c-PJLV-Gaggi-size-small c-PJLV-kaCQqN-color-blue}@layer onevar{${expression1CssText}${expression2CssText}}`,
    );
  });
  ...
  test('Renders a component with 2 matching variants', () => {
    ...
    expect(toString()).toBe(
      `--sxs{--sxs:3 c-PJLV-Gaggi-size-small c-PJLV-iRwLiB-level-1}@layer onevar{${expressionSizeSmallCssText}${expressionLevel1CssText}}`,
    );
  });
  ...
  test('Renders a component with a 2 matching variants and 1 matching compound', () => {
    ...
    expect(toString()).toBe(
      `--sxs{--sxs:3 c-PJLV-kaCQqN-color-blue c-PJLV-Gaggi-size-small}@layer onevar{${expressionColorBlueCssText}${expressionSizeSmallCssText}}--sxs{--sxs:5 c-PJLV-cChFtv-cv}@layer allvar{${expressionCompoundCssText}}`,
    );
  });
});
...
describe('Variants with defaults', () => {
  ...
  test('Renders a component with the default variant applied', () => {
    ...
    expect(toString()).toBe(
      '--sxs{--sxs:3 c-PJLV-Gaggi-size-small}@layer onevar{.c-PJLV-Gaggi-size-small{font-size:16px}}',
    );
  });
  ...
  test('Renders a component with the non-default variant explicitly applied', () => {
    ...
    expect(toString()).toBe(
      '--sxs{--sxs:3 c-PJLV-hsYHIj-size-large}@layer onevar{.c-PJLV-hsYHIj-size-large{font-size:24px}}',
    );
  });
  ...
  test('Renders a component with the default variant applied and a different variant explicitly applied', () => {
    ...
    expect(toString()).toBe(
      '--sxs{--sxs:3 c-PJLV-Gaggi-size-small c-PJLV-iRwLiB-level-1}@layer onevar{' +
        // implicit size:small
        '.c-PJLV-Gaggi-size-small{font-size:16px}' +
        // explicit level:1
  ...
  test('Renders a component with the default variant applied, a different variant explicitly applied, and a compound applied', () => {
    ...
    expect(toString()).toBe(
      '--sxs{--sxs:3 c-PJLV-kaCQqN-color-blue c-PJLV-Gaggi-size-small}@layer onevar{' +
        // explicit color:blue
        '.c-PJLV-kaCQqN-color-blue{background-color:dodgerblue;color:white}' +
        // implicit size:small
        '.c-PJLV-Gaggi-size-small{font-size:16px}' +
        '}--sxs{--sxs:5 c-PJLV-cChFtv-cv}@layer allvar{' +
...
describe('Conditional variants', () => {
  ...
  test('Renders a component with one variant applied', () => {
    ...
    expect(toString()).toBe(
      `--sxs{--sxs:3 c-PJLV-Gaggi-size-small}@layer onevar{${componentSmallCssText}}`,
    );
  });
  ...
  test('Renders a component with one conditional variant on one breakpoint applied', () => {
    ...
    expect(toString()).toBe(
      `--sxs{--sxs:4 c-PJLV-fHtTAQ-size-small}@layer resonevar{${componentSmallBp1CssText}}`,
    );
  });
  ...
  test('Renders a component with one conditional variant on two breakpoints applied', () => {
    ...
    expect(toString()).toBe(
      `--sxs{--sxs:4 c-PJLV-fHtTAQ-size-small c-PJLV-XwbVw-size-large}@layer resonevar{${componentSmallBp1CssText}${componentLargeBp2CssText}}`,
    );
  });
  ...
  test('Renders a component with a conditional variant repeatedly', () => {
    ...
    const componentLargeBp2ClassName = `${componentClassName}-XwbVw-size-large`;
    const componentSmallBp1CssText = `@media (max-width: 767px){.${componentSmallBp1ClassName}{font-size:16px}}`;
    const componentLargeBp2CssText =
