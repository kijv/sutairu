...
suite('Issue #450', () => {
  describe('Basic Tests', () => {
    ...
    test('Render component1() as red, inherited from defaultVariants', () => {
      ...
      expect(getCssText()).toBe(
        '--sxs{--sxs:3 c-PJLV-gmqXFB-color-red}@layer onevar{.c-PJLV-gmqXFB-color-red{color:red}}',
      );
    });
    ...
    test('Render component1({ color: "blue" }) as blue, assigned from props', () => {
      ...
      expect(getCssText()).toBe(
        '--sxs{--sxs:3 c-PJLV-kydkiA-color-blue}@layer onevar{.c-PJLV-kydkiA-color-blue{color:blue}}',
      );
    });
    ...
    test('Render component1({ color: { "@media (width >= 640px)": "blue" } }) as red then blue, inherited from defaultVariants, assigned from props', () => {
      ...
      expect(getCssText()).toBe(
        '--sxs{--sxs:3 c-PJLV-gmqXFB-color-red}@layer onevar{.c-PJLV-gmqXFB-color-red{color:red}}--sxs{--sxs:4 c-PJLV-bBevdw-color-blue}@layer resonevar{@media (min-width: 640px){.c-PJLV-bBevdw-color-blue{color:blue}}}',
      );
    });
    ...
    test('Render component2() as orange, inherited from defaultVariants', () => {
      ...
      expect(getCssText()).toBe(
        '--sxs{--sxs:3 c-PJLV-vMTTG-color-orange}@layer onevar{.c-PJLV-vMTTG-color-orange{color:orange}}',
      );
    });
    ...
    test('Render component2({ color: { "@media (width >= 640px)": "blue" } }) as orange then blue, inherited from defaultVariants, assigned from props', () => {
      ...
      expect(getCssText()).toBe(
        '--sxs{--sxs:3 c-PJLV-vMTTG-color-orange}' +
          '@layer onevar{.c-PJLV-vMTTG-color-orange{color:orange}}' +
          '--sxs{--sxs:4 c-PJLV-bBevdw-color-blue}@layer resonevar{' +
  ...
  describe('Basic Tests ported from the React version', () => {
    ...
    test('Render component1()', () => {
      ...
      expect(getCssText()).toBe(
        '--sxs{--sxs:2 c-jyxqjt}@layer styled{.c-jyxqjt{--component:1}}',
      );
    });
    ...
    test('Render component1({ color: "lightBlue" })', () => {
      ...
      expect(getCssText()).toBe(
        '--sxs{--sxs:2 c-jyxqjt}@layer styled{' +
          '.c-jyxqjt{--component:1}' +
          '}' +
          '--sxs{--sxs:3 c-jyxqjt-ilDyRi-color-lightBlue}@layer onevar{' +
    ...
    test('Render component1({ appearance: "secondary" })', () => {
      ...
      expect(getCssText()).toBe(
        '--sxs{--sxs:2 c-jyxqjt}@layer styled{' +
          '.c-jyxqjt{--component:1}' +
          '}' +
          '--sxs{--sxs:3 c-jyxqjt-cOChOn-appearance-secondary}@layer onevar{' +
    ...
    test('Render component1({ appearance: "secondary", color: "lightBlue" })', () => {
      ...
      expect(getCssText()).toBe(
        '--sxs{--sxs:2 c-jyxqjt}@layer styled{' +
          '.c-jyxqjt{--component:1}' +
          '}' +
          '--sxs{--sxs:3 c-jyxqjt-cOChOn-appearance-secondary c-jyxqjt-ilDyRi-color-lightBlue}@layer onevar{' +
          '.c-jyxqjt-cOChOn-appearance-secondary{--appearance:secondary}' +
          '.c-jyxqjt-ilDyRi-color-lightBlue{--color:lightBlue}' +
          '}' +
          '--sxs{--sxs:5 c-jyxqjt-gYqlvA-cv}@layer allvar{' +
    ...
    test('Render component2()', () => {
      ...
      expect(getCssText()).toBe(
        '--sxs{--sxs:2 c-jyxqjt c-dkRcuu}@layer styled{' +
          '.c-jyxqjt{--component:1}' +
